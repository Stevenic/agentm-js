...
/**
 * Answer returned from a chain-of-thought question.
 */
export interface ChainOfThoughtAnswer {
    /**
     * Explanation of teh reasoning for the answer.
     */
    explanation: string;
 ...
 */
export async function chainOfThought(args: ChainOfThoughtArgs): Promise<PromptCompletion<ChainOfThoughtAnswer>> {
